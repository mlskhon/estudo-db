...
-- Apresente os funcionarios que trabalhem no departamento de filmes OU no departamento de roupas.
...
/* Apresente os funcionarios do sexo masculino ou os funcionarios que trabalhem no setor Jardim.*/

SELECT NOME, SEXO, DEPARTAMENTO FROM funcionarios
WHERE SEXO = 'Masculino' OR DEPARTAMENTO = 'Jardim'
ORDER BY DEPARTAMENTO ASC;

/* MODELO DO BANCO PARA EXERCÍCIO */
